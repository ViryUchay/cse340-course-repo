...
INSERT INTO organization (name, description, contact_email, logo_filename) VALUES
    ...
    ('Riverside Literacy Alliance', 'Provides free tutoring and adult literacy programs across the metro area.', 'info@riversideliteracy.org', 'riverside-logo.png'),
    ('Hands That Heal Health Corps', 'Organizes free community health screenings and wellness workshops.', 'contact@handsthatheal.org', 'handsthatheal-logo.png'),
    ('Second Chance Shelter Network', 'Coordinates shelter, meals, and transitional services for unhoused individuals.', 'info@secondchanceshelter.org', 'secondchance-logo.png'),
    ('Coastal Cleanup Coalition', 'Runs beach and waterway cleanup events and marine conservation education.', 'hello@coastalcleanup.org', 'coastalcleanup-logo.png'),
    ('Youth Rise Mentorship', 'Pairs at-risk youth with mentors for academic and career guidance.', 'contact@youthrise.org', 'youthrise-logo.png'),
    ('Golden Years Companionship', 'Connects volunteers with isolated seniors for regular visits and support.', 'info@goldenyears.org', 'goldenyears-logo.png'),
    ('Paws & Purpose Animal Rescue', 'Rescues and rehomes abandoned animals while running pet-care education programs.', 'hello@pawsandpurpose.org', 'pawspurpose-logo.png'),
    ('Bridges to Employment', 'Offers job-readiness training and resume workshops for the underemployed.', 'contact@bridgestoemployment.org', 'bridges-logo.png'),
    ('Community Harvest Kitchen', 'Prepares and delivers meals to families experiencing food insecurity.', 'info@communityharvest.org', 'harvestkitchen-logo.png'),
    ('Safe Haven Family Services', 'Supports families affected by domestic hardship with counseling and resources.', 'hello@safehavenfamily.org', 'safehaven-logo.png'),
    ('Tech Bridge for Seniors', 'Teaches older adults digital literacy and safe internet use.', 'contact@techbridge.org', 'techbridge-logo.png'),
    ('Green Roots Reforestation', 'Leads tree-planting and habitat restoration projects in urban and rural areas.', 'info@greenroots.org', 'greenroots-logo.png');
